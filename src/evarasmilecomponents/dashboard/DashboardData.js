        ...
        const fetchData = async () => {
            ...
            try {
                const [employeeResponse, leaveResponse, expenseResponse, attendanceResponse, assetResponse] = await Promise.all([
                    axios.get(`https://namami-infotech.com/EvaraBackend/SalesSmile/src/employee/view_employee.php?EmpId=${EmpId}`),
                    axios.get(`https://namami-infotech.com/EvaraBackend/SalesSmile/src/leave/balance_leave.php?empid=${EmpId}`),
                    axios.get(`https://namami-infotech.com/EvaraBackend/SalesSmile/src/expense/get_expense.php?EmpId=${EmpId}`),
                    axios.get(`https://namami-infotech.com/EvaraBackend/SalesSmile/src/attendance/view_attendance.php?EmpId=${EmpId}`),
                    axios.get(`https://namami-infotech.com/EvaraBackend/SalesSmile/src/assets/get_issue_asset.php?EmpId=${EmpId}`)
                ]);
