...
const AssetList = () => {
    ...
    const fetchAssets = async () => {
        try {
            ...
            const response = await axios.get(`https://namami-infotech.com/EvaraBackend/SalesSmile/src/assets/get_issue_asset.php`, { params });
    ...
    const fetchAvailableAssets = async () => {
        try {
            const response = await axios.get('https://namami-infotech.com/EvaraBackend/SalesSmile/src/assets/get_asset.php');
            if (response.data.success) {
    ...
    const handleIssueAssetSubmit = async () => {
        setLoading(true);
        try {
            const response = await axios.post('https://namami-infotech.com/EvaraBackend/SalesSmile/src/assets/issue_asset.php', {
    ...
    const handleAddNewAsset = async () => {
        try {
            const response = await axios.post('https://namami-infotech.com/EvaraBackend/SalesSmile/src/assets/add_asset.php', {
    ...
    const handleStatusChangeSubmit = async () => {
        setLoading(true);
        try {
            const response = await axios.post('https://namami-infotech.com/EvaraBackend/SalesSmile/src/assets/update_asset_status.php', {
        ...
        <div>
            {user.role === 'HR' && (
                <Button
                    ...
                    style={{ backgroundColor: "teal", color: "white", marginBottom: "20px" }}
                >
                    Issue Asset
                </Button>
            )}
